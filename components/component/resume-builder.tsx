  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="w-1/2 bg-white p-8">
        ...
        <p className="mb-6">
          Enthusiastic and highly motivated professional with excellent communication skills and a strong background in
          web development. Eager to bring top-level skills to a dynamic team.
        </p>
        <h2 className="text-xl font-semibold mb-4">Experience</h2>
        <div className="mb-6">
          ...
          <ul className="list-disc pl-5">
            <li>Lead the development of a new e-commerce platform, increasing company revenue by 20%.</li>
            <li>Managed a team of 5 junior developers, providing mentorship and guidance on best practices.</li>
          </ul>
        </div>
        <h2 className="text-xl font-semibold mb-4">Education</h2>
        <div className="mb-6">
      ...
      <aside className="w-1/4 bg-gray-900 p-8 text-white">
        ...
        <div className="flex flex-col space-y-4">
          <Card className="bg-gray-700">
            <CardContent>
              <Avatar>
                <AvatarImage alt="John Doe" src="/placeholder.svg?height=80&width=80" />
              </Avatar>
          ...
          <Card className="bg-gray-700">
            <CardContent>
              <Avatar>
                <AvatarImage alt="Jane Smith" src="/placeholder.svg?height=80&width=80" />
              </Avatar>
