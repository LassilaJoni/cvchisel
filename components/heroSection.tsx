...
import { ArrowRightIcon, BadgeIcon, BookmarkFilledIcon, FaceIcon, ImageIcon, SunIcon } from '@radix-ui/react-icons'
  ...
  <section id="hero" className="relative">
    ...
    <motion.div
      ...
      >
        ...
        Empower Your Job Search with Our Comprehensive and User-Friendly CV Builder
        </p>
